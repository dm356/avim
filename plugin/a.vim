...
if (!exists('g:alternateSearchPath'))
  let g:alternateSearchPath = 'sfr:../source,sfr:../src,sfr:../include,sfr:../inc,sfr:../include/*,sfr:../include/*/*,../../src,../../../src'
endif
      ...
      if (onefile != "")
         ...
         while (n != stop)
            ...
            if (filereadable(expand(nextAlternate)))
                " on cygwin filereadable(expand("foo.H")) returns true if "foo.h" exists
